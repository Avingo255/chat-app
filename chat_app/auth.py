...
class User:
    ...
    def __init__(self, username, display_name, form_group, datetime_joined, password_hash, is_authenticated_field, is_active_field, is_anonymous_field):
...
def load_user(username):
    ...
    user = User(user_record['username'], user_record['display_name'], user_record['form_group'], user_record['datetime_joined'], \
